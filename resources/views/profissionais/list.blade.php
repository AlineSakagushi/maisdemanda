<x-app-layout>
    ...
    <div class="py-10 bg-gradient-to-br from-blue-100 via-sky-100 to-cyan-100 min-h-screen relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Header Section -->
            <div class="bg-gray-200/90 backdrop-blur-lg shadow-xl rounded-2xl p-6 mb-8 border border-white/20">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h3 class="text-2xl font-bold text-gray-800 mb-2">Demandas Disponíveis</h3>
                        <p class="text-gray-600">Encontre oportunidades de trabalho perfeitas para você</p>
                    </div>
